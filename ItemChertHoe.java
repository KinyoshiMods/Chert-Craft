...
public class ItemChertHoe extends Item
{
    protected EnumChertToolMaterial theToolMaterial;

    public ItemChertHoe(int par1, EnumChertToolMaterial par2EnumToolMaterial)
    {
        super(par1);
