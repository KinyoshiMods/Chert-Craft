...
public class BlockPetrifiedChert extends Block
{
	
    protected BlockPetrifiedChert(int par1)
    {
...
//
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4)
    {
        ...
        return var5 == this.blockID ? true : (var5 != Block.leaves.blockID && var5 != Block.wood.blockID ? false : (par1World.getBlockMaterial(par2 - 1, par3 - 1, par4) == Material.leaves ? true : (par1World.getBlockMaterial(par2 + 1, par3 - 1, par4) == Material.leaves ? true : (par1World.getBlockMaterial(par2, par3 - 1, par4 - 1) == Material.leaves ? true : par1World.getBlockMaterial(par2, par3 - 1, par4 + 1) == Material.leaves))));
    }
 ...
 /**
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        ...
        if (this.idDropped(par5, par1World.rand, par7) != this.blockID)
        {
            ...
            if (this.blockID == mod_ChertCraft.BlockPetrifiedChert.blockID)
            {
