...
public class ItemChertTool extends Item
{
    private Block[] blocksEffectiveAgainst;
    protected float efficiencyOnProperMaterial = 4.0F;
    private int damageVsEntity;
    protected EnumChertToolMaterial toolMaterial;

    protected ItemChertTool(int var1, int var2, EnumChertToolMaterial var3, Block[] var4)
    {
        super(var1);
